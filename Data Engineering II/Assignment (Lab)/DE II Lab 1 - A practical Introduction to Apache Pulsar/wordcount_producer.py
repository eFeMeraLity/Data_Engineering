...
producer = client.create_producer('DEIIL1T4')

logging.info('Connected to Pulsar')

# Collection of sentences to serve as random input sequence
sentences = random_cycle(["the cow jumped over the moon",
...
for sentence in sentences:
    ...
    producer.send(sentence.encode('utf-8'))  # publish to pulsar
    # TypeError: Invalid record obj of type <class 'str'> - expected type is <class 'bytes'>
    # Solution: add `.encode('utf-8')`
